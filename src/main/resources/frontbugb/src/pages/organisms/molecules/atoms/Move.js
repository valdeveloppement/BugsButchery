        ...
        if (
            ...
            return (
                <div className="action">
                    <p>
                        Entrez le nom du territoire auquel vous voulez enlever
                        des fourmis :{' '}
                    </p>
                    <input
                        type="text"
                    ...
                    ></input>
                    <p>
                        Entrez le nom du territoire sur lequel vous voulez
                        placer ces fourmis :{' '}
                    </p>
                    <input
                        type="text"
                    ...
                    ></input>
                    <p>
                        Entrez le nombre de fourmis que vous voulez déplacer :{' '}
                    </p>
                    <input
                        type="text"
