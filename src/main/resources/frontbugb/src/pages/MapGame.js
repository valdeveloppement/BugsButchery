            ...
            return (
                <div className="contenant">
                    ...
                    <div className="playingGround">
                        ...
                        <Move changeTerritory1={this.props.changeTerritory1} changeTerritory2={this.props.changeTerritory2} changeNbAnts={this.props.changeNbAnts} skip={this.props.skip} moveAvailable={this.props.moveAvailable} rendering={this.props.gameStatus.moveOn} identity={this.props.playerName} playerTurn={this.props.currentPlayer.playerName} />
